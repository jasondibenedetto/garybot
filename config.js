module.exports = {
  ...
  // i.e: "-garybot foo" will trigger the command "foo",
  //      whereas "garybot foo" will do nothing at all.
  prefix: 'garybot',

  // Your bot's user token. If you don't know what that is, go here:
  // https://discordapp.com/developers/applications/me
  // Then create a new application and grab your token.
  token: 'MzAyMDM5OTkwNzY0ODMwNzMw.C9DyZw.8_8BXyZrsrckE_UZtEtR0ADQa4M',
